    ...
    case "$pkg" in
      ...
      cfssl|cfssljson)
        if ! command -v cfssl &> /dev/null || ! command -v cfssljson &> /dev/null; then
          ...
          curl -s -L -o cfssl https://github.com/${REPO}/releases/download/v${LATEST_TAG}/cfssl_${LATEST_TAG}_linux_${ARCH}
          curl -s -L -o cfssljson https://github.com/${REPO}/releases/download/v${LATEST_TAG}/cfssljson_${LATEST_TAG}_linux_${ARCH}
